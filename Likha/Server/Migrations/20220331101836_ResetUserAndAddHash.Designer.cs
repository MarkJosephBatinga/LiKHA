...
namespace Likha.Server.Migrations
{
    ...
    [Migration("20220331101836_ResetUserAndAddHash")]
    partial class ResetUserAndAddHash
    {
            ...
            modelBuilder.Entity("Likha.Shared.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryId = 1,
                            DateCreated = new DateTime(2022, 3, 31, 18, 18, 35, 468, DateTimeKind.Local).AddTicks(2911),
                        ...
                        new
                        {
                            ...
                            Artist = "Juan Luna",
                            CategoryId = 2,
                            DateCreated = new DateTime(2022, 3, 31, 18, 18, 35, 471, DateTimeKind.Local).AddTicks(335),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ...
                            CategoryId = 3,
                            DateCreated = new DateTime(2022, 3, 31, 18, 18, 35, 471, DateTimeKind.Local).AddTicks(387),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ...
                            Artist = "Vincent van Gogh",
                            CategoryId = 4,
                            DateCreated = new DateTime(2022, 3, 31, 18, 18, 35, 471, DateTimeKind.Local).AddTicks(392),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ...
                            CategoryId = 5,
                            DateCreated = new DateTime(2022, 3, 31, 18, 18, 35, 471, DateTimeKind.Local).AddTicks(396),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
