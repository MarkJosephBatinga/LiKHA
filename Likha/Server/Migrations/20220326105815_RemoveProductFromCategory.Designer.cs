...
namespace Likha.Server.Migrations
{
    ...
    [Migration("20220326105815_RemoveProductFromCategory")]
    partial class RemoveProductFromCategory
    {
            ...
            modelBuilder.Entity("Likha.Shared.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryId = 1,
                            DateCreated = new DateTime(2022, 3, 26, 18, 58, 13, 500, DateTimeKind.Local).AddTicks(2547),
                        ...
                        new
                        {
                            ...
                            Artist = "Juan Luna",
                            CategoryId = 2,
                            DateCreated = new DateTime(2022, 3, 26, 18, 58, 13, 504, DateTimeKind.Local).AddTicks(1241),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ...
                            CategoryId = 3,
                            DateCreated = new DateTime(2022, 3, 26, 18, 58, 13, 504, DateTimeKind.Local).AddTicks(1362),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ...
                            Artist = "Vincent van Gogh",
                            CategoryId = 4,
                            DateCreated = new DateTime(2022, 3, 26, 18, 58, 13, 504, DateTimeKind.Local).AddTicks(1370),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ...
                            CategoryId = 5,
                            DateCreated = new DateTime(2022, 3, 26, 18, 58, 13, 504, DateTimeKind.Local).AddTicks(1375),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
